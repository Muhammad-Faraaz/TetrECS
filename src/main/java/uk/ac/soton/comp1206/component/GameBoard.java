...
public class GameBoard extends GridPane {
  ...
  protected GameBlock createBlock(int x, int y) {
    ...
    block.setOnMouseEntered((e) -> {hovering(block);});
  ...
  /**
   * listener which initiates when a block is right clicked on.
   * @param event
   * @param block
   */
  ...
  /**
   * method to unhover from a block.
   */
  ...
  /**
   * method to hover the chosen game block and unhover once mouse is removed
   * @param gameBlock
   */
  public void hovering(GameBlock gameBlock) {
    if (chosenBlock != null) {
        unHover(chosenBlock);
    }
    chosenBlock = gameBlock;
